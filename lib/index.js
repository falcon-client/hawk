...
class index extends _react2.default.Component {
	...
	render() {
		...
		if (dragging) {
			...
			let connectorStart = (0, _util.computeOutOffsetByIndex)(sourceNode.x, sourceNode.y, this.state.source[1]);
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				connectors.map(connector => {
					...
					let splinestart = (0, _util.computeOutOffsetByIndex)(fromNode.x, fromNode.y, this.computePinIndexfromLabel(fromNode.fields.out, connector.from));
					let splineend = (0, _util.computeInOffsetByIndex)(toNode.x, toNode.y, this.computePinIndexfromLabel(toNode.fields.in, connector.to));
